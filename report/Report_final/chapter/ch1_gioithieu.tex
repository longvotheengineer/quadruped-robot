...
Mặc dù toàn bộ đồ án là sự nỗ lực và phối hợp chặt chẽ của cả nhóm trong suốt quá trình nghiên cứu, thiết kế và thi công. Tuy nhiên, để tối ưu hóa hiệu quả công việc và phát huy thế mạnh của từng thành viên, nhóm đã phân chia các hạng mục chịu trách nhiệm chính như Bảng \ref{tab:phan_cong}.
...
\begin{itemize}
    ...
    \item \textbf{Chương 4 -- Thiết kế và thực hiện phần mềm:} Kiến trúc phần mềm ROS~2, quy trình homing và calibrate.
