...
Kiến trúc phần cứng của hệ thống robot bốn chân được xây dựng nhằm mục tiêu cung cấp nguồn năng lượng ổn định, đảm bảo khả năng xử lý thuật toán phức tạp theo thời gian thực và điều khiển đồng bộ nhiều cơ cấu chấp hành. Sơ đồ kết nối phần cứng tổng thể của mô hình thực nghiệm được thể hiện chi tiết trong Hình 6.1.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{img/fig30-Sơ đồ kết nối phần cứng mô hình thực nghiệm .png }
    \caption{Sơ đồ kết nối phần cứng mô hình thực nghiệm. }
    \label{fig30}
\end{figure}
...
\begin{table}[H]
\centering
\caption{Thông số kỹ thuật cảm biến IMU BNO055}
...
Chuẩn giao tiếp & I2C (hỗ trợ 5V) / SPI (chỉ 3.3V) \\
Địa chỉ I2C mặc định & 0x28 \\
Gia tốc kế (Accelerometer) & $\pm$2g / $\pm$4g / $\pm$8g / $\pm$16g \\
Con quay hồi chuyển (Gyroscope) & $\pm$125$^\circ$/s đến $\pm$2000$^\circ$/s \\
Từ kế (Geomagnetic) & $\pm$1300$\mu$T (trục x,y); $\pm$2500$\mu$T (trục z) \\
Kích thước mạch & 19 $\times$ 21 mm \\
Lỗ bắt vít & Khoảng cách 16mm (Đường kính trong 2mm) \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{img/fig44-sododiday-hethong.pdf} 
...
Left-Front (LF) & A & ID 1 & ID 2 & ID 3 \\ \hline
Right-Behind (RB) & A & ID 7 & ID 8 & ID 9 \\ \hline
Right-Front (RF) & B & ID 4 & ID 5 & ID 6 \\ \hline
Left-Behind (LB) & B & ID 10 & ID 11 & ID 12 \\ \hline
\end{tabular}
\end{table}
...
\section{Chi phí hệ thống}

Bảng~\ref{tab:cost_budget} trình bày ngân sách chi phí cho toàn bộ hệ thống robot, bao gồm linh kiện điện tử, vật liệu cơ khí và phụ kiện.

\begin{table}[H]
\centering
\caption{Ngân sách chi phí hệ thống robot bốn chân}
\label{tab:cost_budget}
\renewcommand{\arraystretch}{1.3}
\begin{tabular}{|l|c|c|c|}
\hline
\textbf{Linh kiện} & \textbf{SL} & \textbf{Đơn giá (VNĐ)} & \textbf{Thành tiền (VNĐ)} \\ \hline
Servo ST3215 & 12 & 350.000 & 4.200.000 \\ \hline
NVIDIA Jetson Nano B01 & 1 & 2.500.000 & 2.500.000 \\ \hline
Nguồn xung 12V-40A & 1 & 250.000 & 250.000 \\ \hline
IMU BNO055 & 1 & 350.000 & 350.000 \\ \hline
Bus Servo Adapter & 2 & 85.000 & 170.000 \\ \hline
Mạch giảm áp XL4015 & 1 & 25.000 & 25.000 \\ \hline
Nhựa PLA (1 kg) & 2 & 200.000 & 400.000 \\ \hline
Ổ bi 626zz & 8 & 15.000 & 120.000 \\ \hline
Ốc vít M3 các loại & -- & -- & 80.000 \\ \hline
Cáp, cos, dây AWG & -- & -- & 150.000 \\ \hline
Thanh liên kết ball-head & 8 & 10.000 & 80.000 \\ \hline
Thẻ nhớ MicroSD 64GB & 1 & 120.000 & 120.000 \\ \hline
\midrule
\textbf{Tổng cộng} & & & \textbf{$\sim$8.445.000} \\ \hline
\end{tabular}
\end{table}

Tổng chi phí hệ thống khoảng 8,5 triệu VNĐ ($\sim$340 USD), thấp hơn đáng kể so với các robot thương mại như Unitree Go1 ($\sim$2.700 USD) hay Boston Dynamics Spot ($\sim$74.500 USD). Phần lớn chi phí nằm ở 12 servo ST3215 ($\sim$50\%) và Jetson Nano ($\sim$30\%). Mức giá này phù hợp cho mục đích nghiên cứu và giáo dục tại Việt Nam.
...
\begin{enumerate}
    ...
    \item Ghi giá trị offset ($\Delta_{calib}$) --- sai lệch giữa vị trí thực tế và vị trí lý thuyết tại góc 0°.
...
\begin{enumerate}
    ...
    \item \textbf{Tính tư thế đích:} Giải IK cho tư thế đứng chuẩn, tạo ra bộ góc đích $\theta_{target,i}$ = (0°, 0°, 90°) cho mỗi chân.
