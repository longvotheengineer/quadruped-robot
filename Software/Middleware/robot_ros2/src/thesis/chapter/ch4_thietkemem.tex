...
Ngược lại, khi vận hành trên robot thực tế, hệ thống loại bỏ các node mô phỏng và thay thế bằng các trình điều khiển phần cứng chuyên dụng như thể hiện ở Hình~\ref{fig:ros2_arch_hw}. Trong đó, node \texttt{serial\_}\allowbreak\texttt{driver\_}\allowbreak\texttt{a} và \texttt{serial\_}\allowbreak\texttt{driver\_}\allowbreak\texttt{b} chịu trách nhiệm giao tiếp UART với 12 động cơ servo, còn node \texttt{imu\_}\allowbreak\texttt{sensor\_}\allowbreak\texttt{node} thu thập dữ liệu trực tiếp từ cảm biến quán tính. Kiến trúc phân tầng này giúp hệ thống đạt độ tin cậy cao, dễ dàng bảo trì và tận dụng lại toàn bộ mã nguồn điều khiển cốt lõi từ mô phỏng.
