...
Nhóm xây dựng một mô hình toán học và cơ khí của robot bốn chân phân bố trong không gian Descartes. Cấu trúc vật lý của robot bao gồm kích thước bệ đỡ với chiều dài $L=250$ mm, chiều rộng $W=193$ mm, và chiều dài các khâu chân lần lượt là $L_1=45$ mm (Coxa/Hip), $L_2=107$ mm (Femur/Thigh), và $L_3=116$ mm (Tibia/Calf), tương đồng với thông số trình bày trong bài báo.
