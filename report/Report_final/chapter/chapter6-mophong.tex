\chapter{Mô phỏng, thực nghiệm và kết quả}
%
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.19\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/Gait/frame_01.png}
        \caption{0.0s}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.19\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/Gait/frame_02.png}
        \caption{0.5s}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.19\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/Gait/frame_03.png}
        \caption{1.0s}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.19\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/Gait/frame_04.png}
        \caption{1.5s}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.19\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/Gait/frame_05.png}
        \caption{2.0s}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.19\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/Gait/frame_06.png}
        \caption{2.5s}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.19\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/Gait/frame_07.png}
        \caption{3.0s}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.19\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/Gait/frame_08.png}
        \caption{3.5s}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.19\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/Gait/frame_09.png}
        \caption{4.0s}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.19\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/Gait/frame_10.png}
        \caption{4.5s}
    \end{subfigure}

   \caption{Chuỗi hình ảnh mô phỏng dáng đi Trot của robot chó trong 5 giây}
    \label{fig:timelapse_gazebo}
\end{figure}

\subsection{Quỹ đạo trong mặt phẳng 2D}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{img/Simulation/fig1_foot_trajectory_2d.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{img/Simulation/fig2_foot_trajectory_3d.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{img/Simulation/fig3_velocity_acceleration.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{img/Simulation/fig4_joint_angles.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{img/Simulation/fig5_pd_torque.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{img/Simulation/fig6_gait_timing.png}
    \caption{Gait timing}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{img/Simulation/fig7_support_polygon.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{img/Simulation/fig8_workspace.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/fig_offline_traj_pos.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/fig_offline_traj_vel_acc.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/fig_offline_traj_angle.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{img/fig_gait_3d.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{img/fig_pid_error_home.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{img/fig_pid_error_gait.png}
...
% TODO: Thêm ảnh robot thực tế đã lắp ráp hoàn chỉnh
% Đặt ảnh vào thư mục img/ với tên file phù hợp
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.7\textwidth]{img/fig_hw_robot_assembled.jpg}
%     \caption{Mô hình robot bốn chân đã lắp ráp hoàn chỉnh}
%     \label{fig_hw_assembled}
% \end{figure}
...
% TODO: Thêm ảnh sơ đồ ROS 2 nodes/topics cho phần cứng thực
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.8\textwidth]{img/fig_hw_ros2_graph.png}
%     \caption{Sơ đồ ROS~2 nodes và topics trên phần cứng thực}
%     \label{fig_hw_ros2_graph}
% \end{figure}
...
% TODO: Thêm ảnh robot ở tư thế đứng chuẩn sau khi homing
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.6\textwidth]{img/fig_hw_homing.jpg}
%     \caption{Robot ở tư thế đứng chuẩn sau quá trình homing}
%     \label{fig_hw_homing}
% \end{figure}
...
% TODO: Thêm ảnh/video chuỗi hình ảnh robot đang đi trot
% \begin{figure}[H]
%     \centering
%     % Có thể dùng subfigure để đặt nhiều ảnh liên tiếp
%     \includegraphics[width=0.8\textwidth]{img/fig_hw_trot_sequence.jpg}
%     \caption{Chuỗi hình ảnh robot thực hiện dáng đi Trot trên mặt phẳng}
%     \label{fig_hw_trot_sequence}
% \end{figure}

% TODO: Thêm nhận xét kết quả thực nghiệm dáng đi
% Ví dụ: Robot di chuyển được / gặp vấn đề gì / so sánh với mô phỏng
...
% TODO: Thêm ảnh robot ở trạng thái sau khi ROBOTOFF hoàn tất
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.6\textwidth]{img/fig_hw_robotoff.jpg}
%     \caption{Robot ở trạng thái an toàn sau khi hoàn tất quy trình ROBOTOFF}
%     \label{fig_hw_robotoff}
% \end{figure}
...
\begin{enumerate}
    ...
    % TODO: Bổ sung thêm các vấn đề thực tế khác nếu có
\end{enumerate}
