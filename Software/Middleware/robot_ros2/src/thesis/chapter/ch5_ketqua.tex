...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.19\textwidth}
        \centering
        \includegraphics[width=\textwidth]{frame_001.jpg}
        \caption{0.0s}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.19\textwidth}
        \centering
        \includegraphics[width=\textwidth]{frame_002.jpg}
        \caption{1.3s}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.19\textwidth}
        \centering
        \includegraphics[width=\textwidth]{frame_003.jpg}
        \caption{2.7s}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.19\textwidth}
        \centering
        \includegraphics[width=\textwidth]{frame_004.jpg}
        \caption{4.0s}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.19\textwidth}
        \centering
        \includegraphics[width=\textwidth]{frame_005.jpg}
        \caption{5.3s}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.19\textwidth}
        \centering
        \includegraphics[width=\textwidth]{frame_006.jpg}
        \caption{6.7s}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.19\textwidth}
        \centering
        \includegraphics[width=\textwidth]{frame_007.jpg}
        \caption{8.0s}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.19\textwidth}
        \centering
        \includegraphics[width=\textwidth]{frame_008.jpg}
        \caption{9.3s}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.19\textwidth}
        \centering
        \includegraphics[width=\textwidth]{frame_009.jpg}
        \caption{10.7s}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.19\textwidth}
        \centering
        \includegraphics[width=\textwidth]{frame_010.jpg}
        \caption{12.0s}
    \end{subfigure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{fig1_foot_trajectory_2d.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{fig2_foot_trajectory_3d.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{fig3_velocity_acceleration.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{fig4_joint_angles.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{fig5_pd_torque.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{fig6_gait_timing.png}
    \caption{Gait timing}
    \label{fig6}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{fig7_support_polygon.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{fig8_workspace.png}
...
Hình~\ref{fig_offline_traj_pos} trình bày quỹ đạo Cartesian $(x, y, z)$ của chân trước bên trái (Left-Front) trong một chu kỳ dáng đi đầy đủ gồm pha vung chân ($T_{swing} = 45$ frame) và pha chống chân ($T_{stance} = 200$ frame). Quỹ đạo trục $x$ thể hiện rõ chuyển động tiến/lùi với biên độ bước $L_{stride} = 10$ mm, trục $y$ duy trì ổn định, và trục $z$ cho thấy biên dạng nâng chân dạng parabol với độ cao $h_{lift} = 80$ mm.
...
Hình~\ref{fig_offline_traj_angle} cho thấy các góc khớp $(\theta_1, \theta_2, \theta_3)$ đã giải qua IK, với pha vung chân và pha chống chân được tô màu phân biệt. Các chuyển tiếp góc khớp mượt mà, không có bước nhảy đột ngột, xác nhận tính đúng đắn của thuật toán IK.
